...
_C.MODEL.ENC_INPUT_DIM = -1 # Dimensionality of the encoder input (same as DATA_DIM for base LFADS)
...
_C.MODEL.BEHAVIOR_DIM = 0 # Number of behavioral dimensions to load (or predict)
...
_C.TRAIN.DATA.AUGMENT.JITTER_WIDTH = 0 # half the width of a uniform distribution used to generate jitter (int value)
